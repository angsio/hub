/*
  ...
  proxies /auth through to the service on 5002. That is the same shape nginx gives us
  in production.
*/
...
/*
  ...
  the auth service is down the hub should still render, since it is a public site.
*/
